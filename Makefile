all: rule_test add_table del_table get_table add_chain del_chain
...
add_table:
	g++ -o addtable -g addtable_no_mnl.cpp iptable_helpers.cpp netfilter_table_controller.cpp

get_table:
	g++ -o gettable -g gettable_no_mnl.cpp iptable_helpers.cpp netfilter_table_controller.cpp 
