...
int main()
{
  ...
  payload_expression ether_payload(NFT_PAYLOAD_LL_HEADER, NFT_REG_2, offsetof(ethhdr, h_source), sizeof(unsigned char[6]));
  
  comparison_expression mac_cmp(NFT_REG_2, NFT_CMP_EQ, )
